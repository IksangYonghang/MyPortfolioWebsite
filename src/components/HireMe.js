...
const HireMe = () => {
  return (
    <div
      className="fixed left-4 bottom-4 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto 
    ...
    >
      <div className="w-48 h-auto flex items-center justify-center relative md:w-24">
        ...
        <Link
          ...
          -translate-y-1/2 bg-dark text-light shadow-md border boder-solid border-dark w-20 h-20 rounded-full font-semibold
